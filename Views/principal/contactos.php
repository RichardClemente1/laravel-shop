...
<!-- Mission, Vision and Objective Section Begin -->
<section class="mission-vision spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="mission-vision__item">
                    <h3>Misión</h3>
                    <p>Ser líderes en el mercado ofreciendo ropa elegante de dama y caballero con la más alta calidad y estilo.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="mission-vision__item">
                    <h3>Visión</h3>
                    <p>Convertirnos en la marca preferida por nuestros clientes, reconocida por nuestra innovación y compromiso con la excelencia.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="mission-vision__item">
                    <h3>Objetivo</h3>
                    <p>Ofrecer una experiencia única de compra, donde nuestros clientes encuentren elegancia y estilo en cada prenda que adquieran.</p>
                </div>
            </div>
        </div>
    </div>
</section>
<!-- Mission, Vision and Objective Section End -->
